...
git clone --depth=1 https://github.com/cetohector/odoo-16-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: *** | Live chat port: $CHAT"